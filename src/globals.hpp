...
namespace GameConstants {
    ...
    static constexpr size_t FIRST_LOCK_INDEX = NUM_CELLS_PER_ROW - 2;
    static constexpr size_t SECOND_LOCK_INDEX = NUM_CELLS_PER_ROW - 1;
    static constexpr int NUM_DICE = 6;
    static constexpr size_t MAX_LEGAL_MOVES = 8;
    static constexpr int MIN_MARKS_FOR_LOCK_ONE = 5;
    static constexpr int MIN_MARKS_FOR_LOCK_TWO = 7;
